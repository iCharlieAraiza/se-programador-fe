# ¿Qué es Sé Programador?

<p className="subtitle text-slate-500"> Proyecto de responsabilidad social para aspirantes a desarrolladores</p>

La plataforma Sé Programador es un proyecto de responsabilidad social que busca ayudar a las personas a aprender a programar y conseguir su primer empleo en el área de tecnología. La plataforma ofrece cursos gratuitos y recursos para que los estudiantes puedan adquirir habilidades necesarias para conseguir entrar al mercado laboral y mejorar sus probabilidades de empleabilidad.
...
Want to contact us?
Connect with our friendly community on discord, a chat and networking platform or send us an email.
